...
import com.lucas.architecture.data.manager.NetState;
...
public abstract class BaseFragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mSharedViewModel = ((EboApplication) mActivity.getApplicationContext()).getAppViewModelProvider(mActivity).get(SharedViewModel.class);
